...
Public Class Reporte_Historial_Ventas
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Reporte_Historial_Ventas.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.Reporte_Historial_Ventas.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_id_venta() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReporte_Historial_Ventas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_Historial_Ventas = New Reporte_Historial_Ventas()
        rpt.Site = Me.Site
        Return rpt
    End Function
